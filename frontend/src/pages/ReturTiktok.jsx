...
const ReturTiktok = () => {
  ...
  const handleSave = async () => {
    ...
    setSaving(true);
    try {
      if (modal.mode === 'add') { await api.post('/retur/tiktok', form); toast.success('Retur TikTok berhasil ditambahkan'); }
      else { await api.put(`/retur/tiktok/${modal.data.id}`, form); toast.success('Retur TikTok berhasil diperbarui'); }
